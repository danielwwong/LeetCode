...
**Boundary Problem**
There're different situations we should consider, for instance, what if the array's length is odd or even, or the array is shorter than ![img](img/1.gif) ![img](img/2.png){:height="25%"}. We need to handle the boundary problem.
